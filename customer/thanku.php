...
<body>
    ...
    <div class="container-fluid bg-dark text-white">
        <h1 class="text-center p-5">Thank You For Your Order!!</h1>
    </div>
    <div class="container my-5 shadow">
        <div class="card border-0 p-4">
            <div class="card-body">
                <div class="mb-4">
                    <h2 class="card-title fw-bold text-success text-center">Order Successful!</h2>
                </div>
                <div class="text-start mx-auto" style="max-width:400px;">
                    <div class="mb-5">
                        <p><strong>Order Id : </strong><?php echo $_GET['oid'];?></p>
                        <p><strong>Total Amount Paid : </strong><?php echo $_GET['order_amount'];?></p>
                        <p><strong>Payment ID : </strong><?php echo $_GET['opid'];?></p>
                    </div>
                    <div class="mb-3 justify-content-center align-items-center d-flex">
                        <a href="index.php" class="btn btn-success">Continue Your Wellness Journey</a>
                    </div>
                </div>
            </div>
        </div>
